...
class FeatureExtraction:
        ...
        try:
            ...
            for head in self.soup.find_all('head'):
                for link in self.soup.find_all('link', href=True):
                    ...
                    if self.url in link['href'] or len(dots) == 1 or domain in link['href']:
                        return 1
            return -1
        except:
            return -1
    ...
    def AnchorURL(self):
        try:
            ...
            for a in self.soup.find_all('a', href=True):
                href = a['href'].lower()
                if "#" in href or "javascript" in href or "mailto" in href or not (self.url in href or domain in href):
                    unsafe += 1
                i += 1
    ...
    def WebsiteTraffic(self):
        try:
            response = urllib.request.urlopen("http://data.alexa.com/data?cli=10&dat=s&url=" + self.url)
